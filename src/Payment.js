...
function Payment() {
    ...
    useEffect(() => {
        ...
        // which allows us charge the customer
    ...
    const handleChange = event => {
        ...
        // And display any errors as customer types card detail
        ...
        <div className="payment">
            <div className="payment__container">
                ...
                <div className="payment__section">
                    <div className="payment__title"><h3>Delivery adress</h3></div>
